...
Public Class Form5
    ...
    Sub repeat()
        ...
        cryRpt.Load(System.IO.Path.GetDirectoryName(System.IO.Path.GetDirectoryName(Application.StartupPath)) & "\CrystalReport1.rpt")
    ...
    Private Sub ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox1.SelectedIndexChanged
        If ComboBox1.Text = "Semua" Then
            ...
            repeat()
        Else
            CrystalReportViewer1.SelectionFormula = "{Command.kesimpulan}= '" & ComboBox1.Text & "'"
            CrystalReportViewer1.RefreshReport()
        End If
    End Sub
